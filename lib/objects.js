...
var _TypedMap_dict, _TypedMap_hasEntries;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TypedMap = exports.objectMatchesLayout = exports.objectsAreSameType = exports.objectNestedAssign = void 0;
/**
...
class TypedMap {
    constructor() {
        _TypedMap_dict.set(this, void 0);
        _TypedMap_hasEntries.set(this, false);
        /**
         ...
         */
        this.toString = () => {
            if (!__classPrivateFieldGet(this, _TypedMap_hasEntries, "f"))
                return '{ }';
        ...
        this.has = (key) => (Object.prototype.hasOwnProperty.call(__classPrivateFieldGet(this, _TypedMap_dict, "f"), key));
        this.get = (key) => (__classPrivateFieldGet(this, _TypedMap_dict, "f")[key]);
        this.keys = () => (Object.keys(__classPrivateFieldGet(this, _TypedMap_dict, "f")));
        this.values = () => (Object.values(__classPrivateFieldGet(this, _TypedMap_dict, "f")));
        this.entries = () => (Object.entries(__classPrivateFieldGet(this, _TypedMap_dict, "f")));
        /**
        ...
        this.set = (key, value) => {
            ...
            __classPrivateFieldGet(this, _TypedMap_dict, "f")[key] = value;
        };
        /**
        ...
        this.delete = (key) => {
            if (this.has(key)) {
                delete __classPrivateFieldGet(this, _TypedMap_dict, "f")[key];
                return true;
            }
            return false;
        };
         ...
         */
        this.clear = () => {
            this.forEachKey((key) => (delete __classPrivateFieldGet(this, _TypedMap_dict, "f")[key]));
        };
        /**
        ...
        __classPrivateFieldSet(this, _TypedMap_dict, {}, "f");
        __classPrivateFieldSet(this, _TypedMap_hasEntries, false, "f");
    }
    [(_TypedMap_dict = new WeakMap(), _TypedMap_hasEntries = new WeakMap(), Symbol.iterator)]() {
        const entries = Object.entries(__classPrivateFieldGet(this, _TypedMap_dict, "f"));
        let index = -1;
        return {
            next: () => {
                index++;
